...
本文说明演化的整体回路、五个演化机制、护栏的构成，以及数据如何驱动演化节奏。原则层面的依据见[设计原则](design-principles.md)；操作细节见 `skills/knowledge-groom/SKILL.md`；演进中的机制（路由自学习、结构挖掘等）见 [roadmap.md](roadmap.md)。
